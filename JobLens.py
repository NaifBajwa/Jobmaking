...
class JobLens:
    ...
    movieID_to_LastDate = {}
    ratingsPath = './Data/userJOBRatings.csv'
    jobPath = './Data/userJOBPath.csv'
    usersPath = './Data/usersPath.csv'
    grName = ''
    
    def loadMovieLensLatestSmall(self, job):
        ...
        with open(self.usersPath, newline='') as csvfile:
                ...
                for row in movieReader:
                    ...
                    self.movieID_to_Arbetsgivare[movieID] = row[2]
                    self.movieID_to_LastDate[movieID] = row[2]
    ...
    def getGenres(self):
        ...
        genreIDs = {}
        maxGenreID = 0
        with open(self.jobPath, newline='', encoding='ISO-8859-1') as csvfile:
            movieReader = csv.reader(csvfile)
            next(movieReader)  #Skip header line
            for row in movieReader:
                movieID = int(row[0])
